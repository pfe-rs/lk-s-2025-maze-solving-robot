...
def formiranjeSkena(robot, mapa, interna_mapa, n):
    
    sken = np.zeros(interna_mapa.shape)
    y, x = robot["interPoz"]
    
    for udaljenost, ugao in pucanjeLasera(robot["pozicija"][1], robot["pozicija"][0], mapa, n):
